...
export default function DearGuests() {
  return (
      <div className="bg-[#FFC1CC] lg:max-w-6xl flex flex-col shadow-[6px_6px_0_black] 
                      justify-center items-left sm:shadow-[12px_12px_0_black] py-4 px-6 mx-6 my-6 sm:my-8
                      w-[90%] xs:w-full">
